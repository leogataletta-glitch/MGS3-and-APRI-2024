...
def _carte_vignette(res):
    ...
    legende = "".join(
        ...
        f'rgba(0,0,0,.12)"></span><span style="font-size:11px;'
...
<style>
  ...
  .a-kpi-v    { font-size:25px; font-weight:700; letter-spacing:-.025em;
                line-height:1; font-variant-numeric:tabular-nums; }
  .a-kpi-l    { font-size:13.5px; font-weight:600; color:#101728;
                margin-top:4px; }
  .a-kpi-s    { font-size:11.5px; color:#8a93a5; margin-top:2px;
                line-height:1.35; }
  ...
  .a-note-x   { font-size:14px; color:#3c4761; line-height:1.6; margin:0;
                max-width:96ch; }
  .a-hist-t    { font-size:12px; letter-spacing:.06em; text-transform:uppercase;
                 font-weight:700; color:#1f7a5a; margin:0 0 4px; }
  .a-hist-p    { font-size:14.5px; color:#3c4761; line-height:1.65;
  ...
  .a-liens-t  { font-size:14px; font-weight:700; color:#101728;
                margin:2px 0 10px; }
  ...
  div[class*="st-key-acces_"] div[data-testid="stButton"] > button::after {
      content:"›"; margin-left:auto; font-size:17.5px; color:#b6bfcd;
      line-height:1; }
</style>
"""
    ...
    with st.container(border=True):
        ...
        for lg, cle, coul, inverse in VEDETTES:
            ...
            cartes.append(
                ...
                f'<div style="font-size:27px;font-weight:700;color:{coul};'
                f'font-variant-numeric:tabular-nums;letter-spacing:-.03em;'
                f'line-height:1.05">{_fmt(val)}'
                f'<span style="font-size:15.5px;margin-left:2px">%</span></div>'
                f'<div style="font-size:12.5px;color:#3c4761;font-weight:600;'
                f'margin-top:5px;line-height:1.35">{_e(T("a_v_" + cle))}</div>'
                f'<div style="font-size:11px;color:#8a93a5;margin-top:3px">'
