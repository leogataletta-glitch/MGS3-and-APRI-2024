...
def render(active, fr):
    ...
    st.markdown(f'''<style>
    {source} [role="radiogroup"]{{display:grid!important;grid-template-columns:repeat(4,minmax(0,1fr))!important;width:100%!important;gap:0!important;padding:4px!important;border:1px solid #dce5df!important;border-radius:24px!important;background:white!important;}}
    {theme} [role="radiogroup"]{{display:grid!important;grid-template-columns:repeat(30,minmax(0,1fr))!important;gap:8px 0!important;padding:4px!important;border:1px solid #dce5df!important;border-radius:24px!important;background:white!important;}}
    ...
    {page} .st-key-exb_q_zone [data-baseweb="select"]>div{{min-height:44px!important;border:1px solid #17513d!important;border-radius:12px!important;background:white!important;}}
