...
def render(key, codes, selected, description=None):
    ...
    {root} [role="radiogroup"]>label p:first-child,{root} [role="radiogroup"]>label strong{{font:700 14px/1.3 Arial,sans-serif!important;text-transform:none!important;letter-spacing:0!important;color:#104b3b!important;text-align:center!important;}}
    {root} [role="radiogroup"]>label p:not(:first-child){{display:block!important;font:400 12px/1.35 Arial,sans-serif!important;color:#61708a!important;text-align:center!important;margin-top:4px!important;}}
    {root} [role="radiogroup"]>label:nth-child({active}){{background:#eaf2ed!important;box-shadow:none!important;border:0!important;border-right:0!important;border-radius:4px!important;}}
