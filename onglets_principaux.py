...
def render(key, codes, selected, description=None):
    ...
    {root} [role="radiogroup"]{{display:flex!important;flex-wrap:wrap!important;gap:8px!important;padding:6px!important;margin:0!important;background:white!important;border:0!important;box-shadow:none!important;}}
    ...
    {root} [role="radiogroup"]>label:nth-child({active}){{background:white!important;box-shadow:0 4px 14px #193c2526!important;}}
    {root} [role="radiogroup"]>label:nth-child({active})::after{{content:"";position:absolute;bottom:7px;top:auto;left:calc(50% - 4px);right:auto;width:8px;height:8px;background:#176344;border-radius:50%;}}
