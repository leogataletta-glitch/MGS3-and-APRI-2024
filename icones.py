...
TRACES = {
    ...
    "monde": '<circle cx="12" cy="12" r="9"/><path d="M3 12h18"/>'
             '<path d="M12 3c2.4 2.6 3.6 5.6 3.6 9s-1.2 6.4-3.6 9c-2.4-2.6'
             '-3.6-5.6-3.6-9s1.2-6.4 3.6-9z"/>',
    "couches": '<path d="M12 3.2l8.6 4.4-8.6 4.4-8.6-4.4z"/>'
               '<path d="M3.4 12.2l8.6 4.4 8.6-4.4"/>'
               '<path d="M3.4 16.6l8.6 4.4 8.6-4.4"/>',
