...
def render(fr):
    ...
    with st.expander(_locale_text('Deux niveaux de comparaison : répondants et territoires' if fr else 'Two comparison levels: respondents and territories'), expanded=True):
