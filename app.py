...
<style>
  ...
  /* LE VOILE DU FILM EST CELUI DES PHOTOGRAPHIES, ET C'EST VOULU. Il avait
     été raccourci pour dégager la scène ; elle a été regardée de plus près,
     et ce qu'elle montre — des paysans haïtiens vêtus de blanc dans une
     image de synthèse — porte un imaginaire colonial dont un site du PNUE
     n'a pas à se faire le relais. Le voile long recouvre les personnages ;
     il ne reste du plan que le motif agricole, les rangs et la colline. */
  .bandeau-marque {
