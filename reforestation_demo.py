...
<style>
*{box-sizing:border-box}body{margin:0;color:#284d43;font:15px/1.55 Arial,sans-serif}h2{font-size:24px;margin:0 0 5px}p{margin:5px 0 15px;color:#657b73}.shell{background:#f5f9f6;border-radius:18px;padding:24px}.layout{display:grid;grid-template-columns:245px 1fr;gap:24px}.controls{background:white;padding:18px;border-radius:12px}label{display:block;margin:15px 0 4px;font-weight:600;font-size:14px}input{width:100%;accent-color:#48896d}output{float:right;color:#527667;font-weight:400}.buttons{display:flex;gap:8px;flex-wrap:wrap;margin:12px 0}button{font:inherit;font-size:13px;border:1px solid #bad2c4;background:white;border-radius:8px;padding:8px 12px;color:#245f49;cursor:pointer}button:hover,button:focus-visible{background:#dfede4}button.primary{background:#36775b;color:white}.graph{width:100%;height:auto;display:block}.node rect{fill:white;stroke:#cbddd2}.node text{fill:#315c4b;font-size:13px}.node .value{font-size:24px;font-weight:700}.edge{fill:none;stroke:#91b2a1;stroke-width:2}.minus{stroke:#c39765}.delayed{stroke-dasharray:6 5}.sign{font-size:19px;fill:#496e5b}.pulse{fill:#276f52}.pulse.negative{fill:#b3783a}.track{fill:none;stroke:#38795b;stroke-width:3}.baseline{fill:none;stroke:#cddbd3;stroke-width:1}#plot{width:100%;height:110px}.note{font-size:12px;margin-top:18px}.legend{font-size:12px}.loops{display:grid;grid-template-columns:repeat(3,1fr);gap:18px;margin-top:12px}.loops div{font-size:13px;border-top:3px solid #a0bfae;padding-top:10px}#status{font-size:13px;font-weight:600}button:disabled{opacity:.5;cursor:default}@media(max-width:700px){.layout{grid-template-columns:1fr}.shell{padding:14px}.controls{display:grid;grid-template-columns:1fr 1fr;gap:0 18px}.presets{grid-column:1/-1}.loops{grid-template-columns:1fr}}
