...
def appliquer(active):
    ...
    {root} [role="radiogroup"]>label p:first-child{{font:700 18px/1.3 Arial,sans-serif!important;text-transform:none!important;letter-spacing:0!important;color:#18202c!important;}}
    ...
    {root} [role="radiogroup"]>label:nth-child({active}){{background:white!important;border-color:#1f6549!important;}}
