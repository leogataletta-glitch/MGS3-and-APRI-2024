...
.stApp .st-key-zone_page [data-testid="stTabs"] [data-baseweb="tab"]{min-height:64px;background:#fff!important;border-radius:0!important;border-right:0!important;padding:12px 18px!important;}
...
.stApp .st-key-zone_page [data-testid="stTabs"] [aria-selected="true"]{background:#edf5ef!important;box-shadow:inset 0 -4px 0 #78a58a!important;}
