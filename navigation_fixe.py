...
def appliquer():
    ...
    .stApp.stApp.stApp.stApp.stApp.stApp .st-key-zone_page :is([data-testid="stSelectbox"],[data-testid="stMultiSelect"]) [data-baseweb="select"]>div{background:#eef2ed!important;border:0!important;min-height:42px!important;border-radius:8px!important;box-shadow:none!important;}
