...
def render(doc_complet=None):
    st.radio("Format", ["Format 1", "Format 2", "Format 3"], horizontal=True,
    ...
    .stApp .st-key-zone_page .st-key-cad_model .cad-dh,.stApp .st-key-zone_page .st-key-cad_model .cad-dl{grid-template-columns:minmax(0,1fr) 190px 90px;gap:24px;padding:15px 12px;}
    .stApp .st-key-zone_page .st-key-cad_model .cad-dh{background:transparent;border-radius:0;font:600 12px/1.4 Arial,sans-serif;letter-spacing:0;text-transform:none;border-bottom:1px solid #cfdcd2;}
    .stApp .st-key-zone_page .st-key-cad_model .cad-dh .cad-dl-v{font-size:12px;font-weight:600;}
    .stApp .st-key-zone_page .st-key-cad_model .cad-dl-n{font:400 15px/1.5 Arial,sans-serif!important;color:#34483e!important;}
    .stApp .st-key-zone_page .st-key-cad_model .cad-dl-r{display:inline-block;min-width:28px;color:#668271;font-size:13px;font-weight:400;}
    .stApp .st-key-zone_page .st-key-cad_model .cad-dl-v{font:500 14px/1.5 Arial,sans-serif;font-variant-numeric:tabular-nums;color:#244b37;}
    .stApp .st-key-zone_page .st-key-cad_model .cad-weight{gap:12px;}
    ...
    @media(max-width:760px){{.stApp .st-key-zone_page .st-key-ong_cad_vue [role="radiogroup"]>label{{flex:1 1 44%!important;}} .stApp:has(.st-key-ong_cad_vue) .st-key-zone_langue_r{{position:relative!important;top:auto!important;right:auto!important;}}}}
    </style>""",unsafe_allow_html=True)
...
def _v_indicateurs():
    ...
    if st.session_state.get("cad_format_choice") in ("Format 2", "Format 3"):
    ...
    g, d = st.columns([1, 1] if st.session_state.get("cad_format_choice") == "Format 3" else [2, 3])
    with g:
...
.md-metrics section{padding:22px 28px;background:linear-gradient(120deg,#f3f8f5,#fff);border:0;border-radius:12px;}
.stApp .st-key-zone_page .md-metrics strong{font:600 48px/1.2 Arial,sans-serif!important;color:#164b3d!important;}
.md-body{display:grid;grid-template-columns:1.25fr 1fr;gap:20px;align-items:stretch;}.md-panel{background:white;border:0;border-radius:0;padding:20px 8px;box-shadow:none;}.md-detail{background:#fafcfb;border:1px solid #e6eee9;border-radius:10px;padding:20px;box-shadow:none;}
