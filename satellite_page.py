...
<style>
 ...
 .stApp .st-key-zone_page p.sat-note.sat-intro-wide { max-width:none!important; width:100%!important; }
</style>
"""
...
def render():
    ...
    st.markdown(
        ...
        f'<p class="sat-note sat-intro-wide" style="margin:0 0 10px">{_e(T("sat_intro", n=len(MESURES)))}</p>',
