...
GRAPHE_DEFAUT = {
    ...
    "aretes": [
        ...
        {"de": "abondance_bois", "vers": "foret", "signe": -1, "force": 0.6, "just": "documentee", "ref_fr": "Le prélèvement suit le stock atteignable : le couvert qui revient devient la coupe de l'année suivante", "ref_en": "Offtake follows the reachable stock: cover that grows back becomes next year's cutting", "rho": None, "p": None},
        {"de": "abondance_bois", "vers": "pression_bois", "signe": -1, "force": 0.45, "just": "documentee", "ref_fr": "La demande de charbon ne cède pas au prix : ce qui est sur pied et atteignable est coupé", "ref_en": "Charcoal demand does not yield to price: what stands and can be reached is cut", "rho": None, "p": None},
